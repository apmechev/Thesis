...
\chapter[Scaling LOFAR Processing]{An Automated Scalable Framework for Distributing Radio Astronomy Processing Across Clusters and Clouds}\label{ch:GRID_LRT}
...
\section{LOFAR Data Processing}\label{sec:lofar_red}
...
\subsection{Data Flow and Processing Steps}\label{sec:dataflow}
...
\subsubsection{Intermediate Data Storage}\label{sec:intermediate_storage}
