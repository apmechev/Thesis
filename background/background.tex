...
\includegraphics[width=.45\linewidth]{background/figures/Maniac_1952.jpg}\quad\includegraphics[width=.45\linewidth]{background/figures/cartesius.jpeg}
    \caption{Two supercomputers sixty years apart. On the left is the MANIAC computer from 1952, while on the right is the Cartesius cluster at SURFsara, in 2018.}
