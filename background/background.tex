...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\linewidth]{background/figures/concat_aoflag_image.jpeg}
    \caption[Image of concatenated data]{Data from L229587 after concatenating groups of 10 subbands and additional RFI Flagging. }
